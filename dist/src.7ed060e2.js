...
var dropZone = document.querySelector(".drop__area");
...
var handleDrop = function handleDrop(e) {
  ...
  var name = file.name;
  uploadFile(file); // drop.insertAdjacentHTML("beforeend", renderAfterDrop(name));

  renderAfterDrop("Your file is: ", name);
};

var renderAfterDrop = function renderAfterDrop(message, data) {
  return drop.insertAdjacentHTML("beforeend", "<p>".concat(message, " ").concat(data, "</p>"));
};

var getTotalBinary = function getTotalBinary(binary) {
  return binary;
};
...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./styles/style.scss":"../src/styles/style.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
