...
},{}],"../src/helpers/storage.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(storage, [{
    ...
    key: "parseJSON",
    value: function parseJSON(value) {
    ...
    value: function set(value) {
      ...
      var newStorage = storage !== null ? _toConsumableArray(value) : value;
...
var _default = new storage("folder");
...
var $dropZone = document.querySelector(".drop__zone");
var $name = document.querySelector(".drop__result-name  span");
var $binary = document.querySelector(".drop__result-binary > span");
var $table = document.querySelector(".drop__history table");
var $list = document.querySelector(".drop__table-list");
var eventsArray = ["dragenter", "dragover", "dragleave", "drop"];
var lastestFiles = [];
...
var handleDrop = function handleDrop(e) {
  ...
  var name = file.name,
      type = file.type; //uploadFile(file);
  //type:
  ...
  var date = (0, _moment.default)(new Date()).format("DD/MM/YYYY");
  console.log(date);
...
var setLastFile = function setLastFile(obj) {
  ...
  _storage.default.set(new Set(lastestFiles));

  displayLastestFiles(lastestFiles);
};

var renderAfterDrop = function renderAfterDrop(DOMElement, data) {
...
function () {
  ...
  regeneratorRuntime.mark(function _callee(file) {
    var formData, data, findTotal, findTotalJSON, total;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return fetch("https://fhirtest.uhn.ca/baseDstu3/Binary", {
              method: "POST",
              body: formData
            });
          ...
          case 5:
            ...
            console.log(data);
            _context.next = 9;
            return fetch("http://hapi.fhir.org/baseDstu3/Binary/_history?");

          case 9:
            findTotal = _context.sent;
            _context.next = 12;
            return findTotal.json();

          case 12:
            findTotalJSON = _context.sent;
            total = findTotalJSON.total;
            console.log(total);
...
var getDatafromStorage = function getDatafromStorage() {
  var data = _storage.default.get();

  if (data === null) {
    return;
  } else if (data !== null && data.length > 0) lastestFiles = _toConsumableArray(data);

  displayLastestFiles(data);
};

var renderLastFile = function renderLastFile(name, date) {
  return "\n        <tr>\n          <td>".concat(name, "</td>\n          <td>").concat(date, "</td>\n        </tr>\n          ");
};

var displayLastestFiles = function displayLastestFiles(array) {
  if (array.length > 0) {
    $list.innerHTML = "";
...
eventsArray.forEach(function (event) {
  return $dropZone.addEventListener(event, preventDefaults);
});
$dropZone.addEventListener("drop", handleDrop);
window.addEventListener("load", getDatafromStorage);
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","moment":"../node_modules/moment/moment.js","./helpers/storage":"../src/helpers/storage.js","./styles/style.scss":"../src/styles/style.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
